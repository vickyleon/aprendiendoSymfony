...
return [
    ...
    'animal' => [[], ['_controller' => 'App\\Controller\\AnimalController::index'], [], [['text', '/animal']], [], []],
    ...
    'animales' => [['nombre', 'apellidos'], ['nombre' => 'Victoria ', 'apellidos' => 'Robes', '_controller' => 'App\\Controller\\HomeController::animales'], ['nombre' => '[a-zA-Z ]+', 'apellidos' => '[a-zA-Z ]+'], [['variable', '/', '[a-zA-Z ]+', 'apellidos', true], ['variable', '/', '[a-zA-Z ]+', 'nombre', true], ['text', '/animales']], [], []],
